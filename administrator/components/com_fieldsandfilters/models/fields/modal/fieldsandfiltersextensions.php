 ...
 * @subpackage  Form
 * @see         JFormFieldModal_FieldsandfiltersExtensions for a select list of type plugins.
 * @since       1.2.0
 */
class JFormFieldModal_FieldsandfiltersExtensions extends JFormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since       1.2.0
	 */
	protected $type = 'Modal_FieldsandfiltersExtensions';
