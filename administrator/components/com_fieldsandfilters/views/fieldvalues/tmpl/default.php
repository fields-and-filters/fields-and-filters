		...
		<table class="table table-striped" id="fieldvalueList">
			<thead>
				<tr>
					...
					<th>
						<?php echo JHtml::_( 'grid.sort',  'COM_FIELDSANDFILTERS_FIELDVALUES_FIELD_VALUE', 'fv.field_value', $listDirn, $listOrder ); ?>
					</th>
					<th  class="hidden-phone">
						<?php echo JHtml::_( 'grid.sort',  'COM_FIELDSANDFILTERS_FIELDVALUES_FIELD', 'f.field_name', $listDirn, $listOrder ); ?>
					</th>
					<th width="1%" class="nowrap hidden-phone">
						<?php echo JHtml::_( 'grid.sort',  'COM_FIELDSANDFILTERS_FIELDVALUES_FIELD_VALUE_ID', 'fv.field_value_id', $listDirn, $listOrder ); ?>
					</th>
				</tr>
			</thead>
			<tbody>
					...
					<td class="nowrap has-context">
						...
						<div class="pull-left">
							<?php
								...
								if( $item->state ) :
									JHtml::_( 'dropdown.unpublish', 'cb' . $i, 'fieldvalues.' );
								else :
									JHtml::_( 'dropdown.publish', 'cb' . $i, 'fieldvalues.' );
								endif;
