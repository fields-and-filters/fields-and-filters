...
<?php endif;?>
		...
		<table class="table table-striped" id="elementList">
			...
			<?php foreach( $this->items as $i => $item ) :
				...
				?>
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo ( !empty( $item->extension_type_id ) ? $item->extension_type_id : 0 ); ?>">
					<td class="order nowrap center hidden-phone">
					<?php
					if( $canChange && !empty( $item->element_id ) ) :
						$disableClassName = '';
						$disabledLabel	  = '';
					...
					<td class="order nowrap center hidden-phone">
						<?php echo JHtml::_( 'grid.id', $i, $item->element_id, empty( $item->element_id ) ); ?>
					</td>
					<td class="center">
						...
						<div class="pull-left">
							<?php
								if( !empty( $item->element_id ) ) :
									...
									JHtml::_( 'dropdown.edit', $item->element_id, 'element.' );
								endif;
