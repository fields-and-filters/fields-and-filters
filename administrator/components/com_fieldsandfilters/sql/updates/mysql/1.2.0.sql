...
ALTER TABLE `#__fieldsandfilters_fields` CHANGE `field_name` `name` VARCHAR(255) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NOT NULL DEFAULT '';
ALTER TABLE `#__fieldsandfilters_fields` CHANGE `field_alias` `alias` VARCHAR(255) CHARACTER SET 'utf8' COLLATE 'utf8_bin' NOT NULL DEFAULT '';
ALTER TABLE `#__fieldsandfilters_fields` CHANGE `field_type` `type` VARCHAR(100) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NOT NULL DEFAULT '';
