...
class FieldsandfiltersControllerRequest extends JControllerLegacy
{
	 ...
	 */
        ...
        {
		// Is ajax requerst
                FieldsandfiltersFactory::getExtensions()->isAjaxRequest() OR die();
                ...
                try
		{
			...
			FieldsandfiltersFactory::getDispatcher()->trigger( 'onFieldsandfiltersRequestJSON', array( $context ) );
	...
	public function fields()
	{
                ...
                try
		{
			...
			FieldsandfiltersFactory::getDispatcher()->trigger( 'onFieldsandfiltersRequestJSON', array( $context, $field ) );
