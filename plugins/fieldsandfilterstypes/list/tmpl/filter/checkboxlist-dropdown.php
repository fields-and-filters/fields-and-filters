...
JHtml::_('stylesheet', 'fieldsandfilters/filters/dropdown.css', array(), true, false, false, false, false);
JHtml::_('script', 'fieldsandfilters/filters/dropdown.js', false, true, false, false, false);
?>

<fieldset id="<?php echo $id; ?>" class="faf-filters faf-filters-list faf-filters-dropdown <?php echo htmlspecialchars($field->params->get('base.class', '')); ?>">
    ...
    <ul class="faf-control-dropdown">
	<?php foreach ($values AS &$value) : ?>
		<li class="control-group faf-control-group">
