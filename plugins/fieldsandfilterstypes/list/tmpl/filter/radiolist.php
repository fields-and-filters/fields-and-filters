...
<fieldset id="<?php echo $id; ?>" data-alias="<?php echo $field->alias; ?>" class="faf-filters faf-filters-radiolist <?php echo htmlspecialchars($field->params->get('base.class', '')); ?>">
	...
	<?php foreach ($values AS &$value) : ?>
		<div class="control-group faf-control-group">
			<input type="radio" name="fieldsandfilters[<?php echo $field->id; ?>]" id="<?php echo($id . '-' . $value->id); ?>"
			...
			<label for="<?php echo($id . '-' . $value->id); ?>" class="radio">
