...
<fieldset id="<?php echo $id; ?>" data-alias="<?php echo $field->alias; ?>" class="faf-filters faf-filters-multiselectlist <?php echo htmlspecialchars($field->params->get('base.class', '')); ?>">
